        ...
        <div class="order-content">
                        ...
                        <tr v-for="(orderDetail,index) in order.orderDetailList" :key="orderDetail.id">
                            <td width="60%">
                                <div class="typographic">
                                    <img width="82px" height="82px" :src="orderDetail.imgUrl">
            ...
            <div class="choose-order">
                <div class="pagination">
                    <Pagination :pageNo="page" :pageSize="limit" :total="myOrder.total" :continues="5" @getPageNo="getPageNo"/><!--prop父子传递数据,自定义事件(事件名)-->
...
export default {
    ...
    methods: {
        async getData() {
            try {
                await this.$store.dispatch('getMyOrderInfo', { page: this.page, limit: this.limit })
            } catch (error) {
                alert(error.message)
            }
        },
